...
int main(int argc, char** argv) {
  ...
  //Connecting to ngfuzz
  Py_Initialize();
  pName = PyUnicode_DecodeFSDefault("ngfuzz.py");
  ...
  if (pModule != NULL) {
      pFunc = PyObject_GetAttrString(pModule, "gen_model");
      /* pFunc is a new reference */

      if (pFunc && PyCallable_Check(pFunc)) {
          pArgs = PyUnicode_DecodeFSDefault("id:000491,src:000327,op:havoc,rep:2");
